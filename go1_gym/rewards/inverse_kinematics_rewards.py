...
class InverseKinematicsRewards:
    ...
    def _reward_manip_pos_tracking(self):
        ...
        ee_idx = self.env.gym.find_actor_rigid_body_handle(self.env.envs[0], self.env.robot_actor_handles[0], "link06")
    ...
    #     '''
    #     arm_joints_torques = self.env.torques[:, 12:18] 
    #     arm_joints_vel = self.env.dof_vel[:, 12:18]
