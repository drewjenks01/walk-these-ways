...
class Camera(object):
    def __init__(self):
        ...
        # width, height = 928, 400
        width, height = 464, 400
        self.fps = 15
        print("Set cap")
...
#            print("receiving img")
            ...
            crop_width = 30
            rgb_img = rgb_img[crop_width:-crop_width, crop_width:-crop_width, :]
            # self.mp4_writer.append_data(rgb_img)
            cv2.imwrite(f"../MiDaS/input/fish_{self.idx}.png", rgb_img)
